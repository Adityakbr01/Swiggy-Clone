...
function Navbar() {
  return (
    <div className="w-full h-20 bg-[#fff] flex items-center justify-between fixed left-0 top-0 lg:px-[10rem] shadow-md">
      <div className="left-Navbar flex items-center gap-14">
        <div>
          <svg
            class="_8pSp-"
            viewBox="0 0 559 825"
